...
namespace Fbi.QuickBooksSolutionTemplate
{
    ...
    public class foo
    {
        public static string asdf = "I EXIST";
    }
  public class IntuitAuthClient
  {
    ...
    public IntuitAuthClient(ISecureStorage secureStorage)
    {
        ...
        client = new HttpClient() { BaseAddress = new Uri("https://oauth.platform.intuit.com") };
        client.DefaultRequestHeaders.Authorization =
            new AuthenticationHeaderValue("Basic", "UTBQMEZqR0tyYWNQbGt3RUpxeFk3QmdrS2hIcDN0RXdTUGtDUW5NR0tjdjRWbzd5VVM6R0IzU2hnaEpBQk1GTENxeWl3Z1NPRVNWeGJLUjJFMzhUWnh4Tmtzdg==");
        client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
        }
